...
export default function MajorGraph({
	...
	const ordering = isConstrained
		? graph.constrainedOrdering(startTerm, maxCredits)
		: graph.unconstrainedOrdering()
	return (
...
>) {
	...
	const [animationFrame, setAnimationFrame] = useState<number>(numFrames - 1)
